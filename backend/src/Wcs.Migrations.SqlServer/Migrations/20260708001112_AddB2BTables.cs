        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    response_status = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    ...
                    client_ip = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    error_message = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    called_at = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    biz_day = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    batch = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    box_no = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    chute_no = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    end_time = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    barcode2 = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    log_type = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    biz_day = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    batch = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    barcode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    equipment_no = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ...
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    test_data_id = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    batch = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    barcode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    chute_no = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
