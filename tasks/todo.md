...
- [x] ~~**[묶음 A — 현장 quick-fix]**~~ **✅ 해소 확인(2026-07-31 S-AUDIT-A-FIELD-QUICKFIX 재triage)** — 세 항목 전부 이미 S-CLEANUP-FIELD(APPROVED 2026-07-07 D-1~D-4)에서 구현·테스트 완료. `CleanupFieldM1Tests` 19/19 GREEN @HEAD 재확인. stale 체크박스였음. (①OFFLINE 로그: PlcGateway Interlocked CAS 전이 1회+주기 요약·rollOnFileSizeLimit=true / ②/health: Program.cs:342 / ③입력 상한: RcsController IF-05·IF-10 barcode≤200·timeStamp≤30·qty>0·음수 거부→400.) 원 항목: ①OFFLINE 무억제 반복+rollOnFileSizeLimit ②/health ③IF-05/10 입력 상한.
